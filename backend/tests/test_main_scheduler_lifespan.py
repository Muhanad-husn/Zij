"""Locked outer acceptance test (DEC-1) for issue #113: the scheduler and a
...
# ===========================================================================
# Inner unit test (DEC-34, authored by the test-author from the plan's unit
...
#
# Locked introspection seam this test asks the implementer to expose:
