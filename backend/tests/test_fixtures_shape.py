...
node and way types). It is authored and committed red by the author
before the fixtures exist, guarded by a strict xfail (): the maintainer
...
maintainer-run capture script has produced the two committed fixture files and
