/**
 * DEC-1 locked outer acceptance test — frontend/02-badges (issue #58).
 ...
 *      implementer's/inner-unit-tests' choice, not locked here).
...
// the implementer wires up to read these same tokens.
 ...
 * on load, or a marine fetch the implementer may add) from 404ing noisily. */
