 ...
 * (DEC-33): it marks the scenario "expected to fail." An unexpected *pass*
 * fails the run, so once the implementer greens the behavior, this file must
 * flip to failing-the-run until the test-author removes the `test.fail()`
