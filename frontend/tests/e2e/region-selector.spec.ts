/**
 * DEC-1 locked outer acceptance test — frontend/03-region-selector (issue
 ...
 *      implementer could add without ever rendering it.
...
test(
  ...
  async ({ page }) => {
    ...
    try {
      ...
      // implementer fired one estimate call per field change instead of
