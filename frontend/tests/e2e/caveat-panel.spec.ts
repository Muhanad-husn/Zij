/**
 * DEC-1 locked outer acceptance test — frontend/05-caveat-panel (issue #61).
 ...
 *      footer). Exact formatting/layout is the implementer's choice; only
 ...
 *      [data-testid="caveats-button"]` (shipped in slice 02, `badges.ts`)
