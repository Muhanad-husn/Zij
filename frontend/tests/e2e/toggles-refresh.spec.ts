/**
 * DEC-1 locked outer acceptance test — frontend/04-toggles-refresh (issue #60).
 ...
 * slice 06) and is not touched by this test.
 *
 ...
 *      established by slice 02/03 (`source.setData({ type:
...
/** `window.__zijMap.getSource(id)` feature count (slice-01 seam, reused
