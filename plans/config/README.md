...
| 03 | [precedence](03-precedence.md) | user-TOML < `ZIJ_` env < DB `config_override` merge + active-region restore | config/02, store/03 | ⏳ PR open (v1) | [#76](https://github.com/Muhanad-husn/Zij/pull/76) |
